...
r.execute_command("FT.CREATE cases ON HASH PREFIX 1 amlcases: SCHEMA caseid TAG SORTABLE status TAG SORTABLE investigator TAG SORTABLE value NUMERIC SORTABLE files TAG SORTABLE reportdate NUMERIC SORTABLE lastupdate NUMERIC SORTABLE casebody TEXT account TAG SORTABLE phone TEXT NOSTEM ip TEXT NOSTEM priority TAG SORTABLE relatedtags TAG SORTABLE ssn TAG SORTABLE")
